...
function TimeSeries() {
    ...
    this.draw = function() {
        ...
        var margin = {top: 20, right: 0, bottom: 50, left: 35},
        ...
        svg = d3.select("#time_series_container").append("svg")
        ...
        d3.tsv(filename, function (error, data) {
            ...
            issue.append("path")
                ...
                .style("stroke", function (d) {
                    //return color(d.name);
                    return $index.getCollegeColor(d.name);
                })
            ...
            datFeel.append("rect")
                ...
                .on("click", function (d) { // On click make d.visible
                    ...
                    $employment_filter.filterCollege(d.name);
                    ...
                    issue.select("path")
                        ...
                        .attr("d", function (d) {
                            ...
                            return $employment_filter.isExcluded(d.name) == false ? line(d.values) : null; // If d.visible is true then draw line for this d selection
                        });
    ...
    this.update = function() {
        ...
        d3.tsv(filename, function (error, data) {
            ...
            issue.select("path") // Redraw lines based on brush xAxis scale and domain
                .transition()
                .attr("d", function (d) {
                    return $employment_filter.isExcluded(d.name) == false ? line(d.values) : null; // If not excluded then draw line for this d selection
                });
